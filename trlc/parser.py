...
class Parser(Parser_Base):
    ...
    def parse_factor(self, scope):
        ...
        if self.peek_kw("not"):
            ...
            if self.peek("OPERATOR") and self.nt.value == "**":
                ...
                rhs_value = n_rhs.evaluate(self.mh, None, self.stab)
    ...
    def parse_builtin(self, scope, n_name, t_name):
        ...
        if n_name.name == "len":
            ...
            try:
                ...
                value = parameters[1].evaluate(self.mh, None, self.stab)
    ...
    def parse_name(self, scope):
        ...
        while self.peek("DOT") or self.peek("S_BRA"):
            if self.peek("DOT"):
                if not isinstance(n_name.typ, (ast.Tuple_Type, ast.Record_Type)):
